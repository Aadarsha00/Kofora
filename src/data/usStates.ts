// USPS/UPS 2-letter state codes - UPS's rating and validation APIs reject the
// full state name outright, so this is used to render a dropdown (not a free
// text field) wherever a US address is collected.
